...
# Data paths
INPUT_PATH = '/project/ssd-stu-research/ploertscher/thesis_code/text-processing/data/full_filt/4_posts_og_content_de.csv'
OUTPUT_PATH = '/project/ssd-stu-research/ploertscher/thesis_code/ideological_resonance_thesis/w2v/data/clean_final_de.csv'
...
STOPWORDS_PATH = '/project/ssd-stu-research/ploertscher/thesis_code/ideological_resonance_thesis/w2v/preprocessing/stopwords_de.py'
...
def main():
    print(f"[INFO] Starting preprocessing pipeline for German data")
